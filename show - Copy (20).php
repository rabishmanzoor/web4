...
.viddiv1:hover { -moz-box-shadow: 0 0 10% #ccc; -webkit-box-shadow: 0 0 10% #ccc; box-shadow: 0 0 10% #ccc; } 
...
<div class="innerrelatedvid1">
<ul>

<li><a href="http://localhost/web4/show.php?id='.$id.'"><img src=" '.$id.'.jpg " height="100%" width="100%"></a></li>
